...
def count_vartrix(vardir, vcfdir):
    ...
    for variant in variant_list:
        ...
        entry = {'map':loci, 'chromosome':str(chromosomes[index]), 'position':str(positions[index]), 'allele':allele, 'ref_count':ref_list[index], 'alt_count':alt_list[index], 'count':len(cell_list[index])}
